...
#define CDLL_IMPORT "CDLL_IMP"
  ...
  // F�r CAPL-aufgerufene Funktionen brauchen wir einen verl��lichen Modifizierer
...
// Problem k�nnte noch sein, wenn _pascal sp�ter noch umdefiniert wird
// -> Ein Nachtest in den Implementierungsfiles w�re sinnvoll
#ifdef _MSC_VER
